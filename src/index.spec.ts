...
describe('gptParser', () => {
    test('transform JSON to valid object', () => {
      expect(gptParser(output)).toBe({"age": 23, "city": "TestCity", "country": "TestCountry", "country_code": "testCode", "hobbies": "Music, It, Games", "lastname": "TestLastName", "name": "TestName", "nick_name": "TestNickName", "street": "TestStreet", "test_value": true});
    });
